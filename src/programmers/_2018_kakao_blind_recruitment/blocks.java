...
public class blocks {
    public static void main(String[] args) {
        Solution_blocks s = new Solution_blocks();
        //s.solution(4,5, new String[]{"CCBDE", "AAADE", "AAABF", "CCBBF"});
        //s.solution(6,6, new String[]{"AABBEE","AAAEEE","VAAEEV","AABBEE","AACCEE","VVCCEE"});
        s.solution(6,2,new String[]{"DD","CC","AA","AA","CC","DD"});
    }
}

class Solution_blocks{
    int answer = 0;
