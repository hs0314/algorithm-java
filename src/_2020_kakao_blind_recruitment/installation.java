package _2020_kakao_blind_recruitment;
...
public class installation {
    public static void main(String[] args) {
        Solution_installation s = new Solution_installation();
        //s.solution(5, new int[][]{{1,0,0,1},{1,1,1,1},{2,1,0,1},{2,2,1,1},{5,0,0,1},{5,1,0,1},{4,2,1,1},{3,2,1,1}});
        s.solution(5, new int[][]{ {0,0,0,1},{2,0,0,1},{4,0,0,1},{0,1,1,1},{1,1,1,1},{2,1,1,1}, {3,1,1,1}, {2,0,0,0}, {1,1,1,0}, {2,2,0,1} });
    }
}
class Solution_installation{
        ...
        if(action == 1) {
            ...
            if (tgt.type == 0) {
                ...
                if (tgt.y == 0) {
                    ...
                    if ((hori_left || hori_right) && !(hori_left && hori_right)) buildable = true;
                }
